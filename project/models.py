...
class RecentProject(models.Model):
    ...
    project = models.ForeignKey(
        Project,
        on_delete=models.CASCADE,
        related_name="recently_accessed_by",
    )
...
class ProjectBoard(models.Model):
    ...
    view_mode = models.CharField(
        max_length=50,
        choices=BoardViewMode.choices,
        default=BoardViewMode.BOARD,
    )
...
class RetrospectiveBoard(models.Model):
    ...
    sprint = models.OneToOneField(
        Sprint,
        on_delete=models.CASCADE,
        related_name="retrospective_board",
    )
...
class Release(models.Model):
    ...
    modified_by = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        null=True,
        related_name="modified_releases",
    )
